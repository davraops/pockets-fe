#!/usr/bin/env node
/**
 * Reemplaza console.error/log/warn por devError/devLog/devWarn en páginas de Trabajo.
 */
...
const TRABAJO_PAGES = ['Contratos.tsx', 'Actividades.tsx']
...
for (const file of TRABAJO_PAGES) {
