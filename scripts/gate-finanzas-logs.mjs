#!/usr/bin/env node
/**
 * Reemplaza console.error/log/warn por devError/devLog/devWarn en páginas de Finanzas.
 */
...
const FINANZAS_PAGES = [
  'Finanzas.tsx',
  'Cuentas.tsx',
  'Transacciones.tsx',
  'Presupuestos.tsx',
  'DiseñadorPresupuestos.tsx',
  'Deudas.tsx',
  'TarjetasCredito.tsx',
  'TarjetasDebito.tsx',
  'Subscripciones.tsx',
...
for (const file of FINANZAS_PAGES) {
